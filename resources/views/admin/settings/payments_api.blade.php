                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['url' => route('admin.settings.saveSettings'), 'method' => 'patch','enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <div class="input-group mb-3">
                                            ...
                                            <span class="text-muted">{{__('Paste it on webhook URL to receive ride updates from Stripe')}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <div class="input-group mb-3">
                                            ...
                                            <span class="text-muted">{{__('Paste it on webhook URL to receive ride updates from Paypal')}}</span>
                                        </div>
                                ...
                                <!-- 'Boolean enable_mercado_pago Field' -->
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <div class="input-group mb-3">
                                            ...
                                            <span class="text-muted">{{__('Paste it on webhook URL to receive ride updates from Mercado Pago')}}</span>
                                        </div>
