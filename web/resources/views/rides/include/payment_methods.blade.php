<div class="row" id="divPaymentMethods">
    @foreach(($offlinePaymentMethods??[]) as $offlinePaymentMethod)
        <div class="col-md-3 pb-2">
            <div id="{{ $offlinePaymentMethod->id }}-payment-card" class="card m-0 text-center selectedPaymentMethod p-2" data-type="offline" data-id="{{$offlinePaymentMethod->id}}" style="cursor:pointer;height: 120px!important;">
                <center>
    ...
    @if(setting('enable_stripe'))
        <div class="col-md-3 pb-2">
            <div id="stripe-payment-card" class="card m-0 text-center selectedPaymentMethod p-2" data-type="online" data-id="stripe" style="cursor:pointer;height: 120px!important;">
                <center>
    ...
    @if(setting('enable_paypal'))
        <div class="col-md-3 pb-2">
            <div id="paypal-payment-card" class="card m-0 text-center selectedPaymentMethod p-2" data-type="online" data-id="paypal" style="cursor:pointer;height: 120px!important;">
                <center>
    ...
    @if(setting('enable_mercado_pago'))
        <div class="col-md-3 pb-2">
            <div id="mercado_pago-payment-card" class="card m-0 text-center selectedPaymentMethod p-2" data-type="online" data-id="mercado_pago" style="cursor:pointer;height: 120px!important;">
                <center>
    ...
    @if(setting('enable_flutterwave'))
        <div class="col-md-3 pb-2">
            <div id="flutterwave-payment-card" class="card m-0 text-center selectedPaymentMethod p-2" data-type="online" data-id="flutterwave" style="cursor:pointer;height: 120px!important;">
                <center>
    ...
    @if(setting('enable_razorpay'))
        <div class="col-md-3 pb-2">
            <div id="razorpay-payment-card" class="card m-0 text-center selectedPaymentMethod p-2" data-type="online" data-id="razorpay" style="cursor:pointer;height: 120px!important;">
                <center>
