...
class UserAPIController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        try {
            ...
            $user = User::find(Auth::id())->append('addresses')->makeVisible('api_token');
        ...
        try {
            ...
            if (isset($input['image']) && $input['image']) {
                ...
                Media::where('id', '!=', $user->media->last()->id)
                    ...
                    ->delete();
                $user = User::find($user->id)->append('addresses')->makeVisible('api_token');
    ...
    public function updateProfile(UpdateUserAPIRequest $request)
    {
        ...
        $user = User::find(Auth::id())->append('addresses')->makeVisible('api_token');
        if(env('APP_DEMO') && $user->email == 'admin@admin.com'){
    ...
    function deleteAccount()
    {
        try {
            ...
            if ($user->driver()->exists()) {
                $user->driver()->update(['active' => false, 'last_location_at' => null, 'lat' => null, 'lng' => null]);
            }
