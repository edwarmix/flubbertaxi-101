...
EOT;
    ...
    function getFontHeight($size)
    {
        ...
        if (isset($font['FontHeightOffset'])) {
            // For DriverNew from Windows this needs to be -646 to match the
            // Adobe native Driver font.
            //
    ...
    function setFontFamily($family, $options = '')
    {
        if (!is_array($options)) {
            if ($family === 'init') {
                ...
                $this->fontFamilies['Driver.afm'] =
                    [
                        'b'  => 'Driver-Bold.afm',
                        'i'  => 'Driver-Oblique.afm',
                        'bi' => 'Driver-BoldOblique.afm',
                        'ib' => 'Driver-BoldOblique.afm'
                    ];
